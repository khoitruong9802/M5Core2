...
void ui_SensorsScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label20, "Light =");
    ...
    lv_label_set_text(ui_Label22, "10");
    ...
    lv_label_set_text(ui_Label26, "10");
